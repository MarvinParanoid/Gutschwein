...
MESSAGES: dict[str, dict[str, str]] = {
    ...
    "digest.on_cards": {
        RU: "На картах: <b>{amount}</b> на {cards} шт.",
        EN: "On the cards: <b>{amount}</b> across {cards} of them",
        DE: "Auf den Karten: <b>{amount}</b> auf {cards} Stück",
    },
    "digest.on_cards_one": {
        RU: "На картах: <b>{amount}</b> на 1 шт.",
        EN: "On the cards: <b>{amount}</b> on a single one",
        DE: "Auf den Karten: <b>{amount}</b> auf einer einzigen",
    },
    "digest.spent": {
        RU: "Потратили: {amount}",
        EN: "Spent: {amount}",
        DE: "Ausgegeben: {amount}",
    },
    "digest.spent_delta": {
        RU: "Потратили: {amount} — на {diff} {direction}, чем неделей раньше",
        EN: "Spent: {amount} — {diff} {direction} than the week before",
        DE: "Ausgegeben: {amount} — {diff} {direction} als in der Woche davor",
    },
    ...
    "digest.expiring": {
        RU: "⏳ Истекает за {days} дней: <b>{amount}</b> — {names}",
        EN: "⏳ Expiring within {days} days: <b>{amount}</b> — {names}",
        DE: "⏳ Läuft in {days} Tagen ab: <b>{amount}</b> — {names}",
    },
    "digest.and_more": {RU: " и ещё {count}", EN: " and {count} more", DE: " und {count} weitere"},
    "digest.uncertain": {
        RU: "❔ Под вопросом: {amount} на {cards} карт(ах) — проверьте остаток",
        EN: "❔ In question: {amount} on {cards} cards — check the balance",
        DE: "❔ Unklar: {amount} auf {cards} Karten — Guthaben prüfen",
    },
    "digest.uncertain_one": {
        RU: "❔ Под вопросом: {amount} на одной карте — проверьте остаток",
        EN: "❔ In question: {amount} on one card — check the balance",
        DE: "❔ Unklar: {amount} auf einer Karte — Guthaben prüfen",
    },
    "digest.expired": {
        RU: "⚠️ Уже истекли, а деньги остались: <b>{amount}</b>",
        EN: "⚠️ Already expired with money left: <b>{amount}</b>",
        DE: "⚠️ Bereits abgelaufen, Geld noch drauf: <b>{amount}</b>",
    },
}
